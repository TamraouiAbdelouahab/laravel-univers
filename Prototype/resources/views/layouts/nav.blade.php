    ...
    <body>
        <div class="bg-gray-100 font-sans w-full m-0">
            ...
            <div class="flex items-center justify-between py-4">
                ...
                <a href="{{route('home')}}" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Accueil</a>
                <a href="#" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">à propos</a>
                <a href="{{route('contact')}}" class="text-gray-800 text-sm font-semibold hover:text-purple-600 mr-4">Contact</a>
                </div>
